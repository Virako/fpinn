...
function copiassh {
    ...
    if [ $2 = "c" ]; then
        ...
        scp -C $NOMBRETAR $USUARIO_REMOTO@chaparobo.no-ip.com:dump_datos.sql.tar.gz
    elif [ $2 = "p" ]; then
