...
class SeriesFacturasVenta(Ventana, VentanaGenerica):
    CLASE = pclases.SerieFacturasVenta
    ...
    def activar_widgets(self, s, chequear_permisos = True):
        ...
        if chequear_permisos:
            self.check_permisos(nombre_fichero_ventana = "serie_facturas_venta.py")
    ...
    def borrar(self, widget):
        ...
        try:
            ...
            self.logger.error("series_facturas_venta.py::borrar -> %s ID %d no se pudo eliminar. Excepción: %s." % (self.objeto.sqlmeta.table, self.objeto.id, e))
