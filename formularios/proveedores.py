...
class Proveedores(Ventana, VentanaGenerica):
    CLASE = pclases.Proveedor
    VENTANA = os.path.join("..", "ui", "proveedores.glade")
    ...
    def nuevo(self, widget):
        ...
        nombre = utils.dialogo_entrada(titulo = "NOMBRE PROVEEDOR", 
    ...
    def buscar(self, widget):
        ...
        a_buscar = utils.dialogo_entrada(titulo = "BUSCAR %s" % self.clase.sqlmeta.table.upper(), 
                                         texto = "Introduzca nombre, C.I.F. o teléfono:", 
                                         padre = self.wids['ventana']) 
        if a_buscar != None:
            try:
    ...
    def borrar(self, widget):
        ...
        try:
            ...
            self.logger.error("proveedores.py::borrar -> %s ID %d no se pudo eliminar. Excepción: %s." % (self.objeto.sqlmeta.table, self.objeto.id, e))
